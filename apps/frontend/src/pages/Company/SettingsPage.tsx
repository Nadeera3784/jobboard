...
export const CompanySettingsPage = () => {
  ...
  const handleSubmit = async (formData: UpdateUserSettingsType, imageFile?: File) => {
    setIsLoading(true);
    try {
      let response;
      ...
      if (imageFile) {
        ...
        response = await httpClient.put(`${AppConstants.API_URL}/users/user-settings`, data, {
          headers: {
        ...
        response = await httpClient.put(`${AppConstants.API_URL}/users/user-settings`, formData);
      }
