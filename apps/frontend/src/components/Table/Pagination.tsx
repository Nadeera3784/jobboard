        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="inline-block relative w-20">
            <select
              ...
              className="flex appearance-none w-full bg-white border border-input hover:border-gray-500 px-3 py-1 rounded shadow text-sm focus:outline-none focus:shadow-outline h-8 [&>span]:line-clamp-1"
            >
