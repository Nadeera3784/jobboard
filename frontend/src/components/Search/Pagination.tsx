...
const Pagination: React.FC<SearchPaginationProps> = ({ currentPage, onPageChange, startPage, endPage, totalCount, limit }) => {
    const getTotalCount = (count: number, limit: number) => Math.ceil(count / limit);
    return (
