...
export class ElasticSearchClient {
    ...
    async singleIndex(index: string, record: any, logSuccess = true): Promise<void> {
        const bulkBody = [];
    ...
    async bulkIndex(index: string, records: any[], routing: any = null): Promise<void> {
        const bulkBody = [];
    ...
    async reIndex(oldIndex: string, newIndex: string, callback: () => Promise<void>): Promise<void> {
        try {
    ...
    async setupFieldMapping(index: string, field: string, config: ElasticFieldConfigInterface): Promise<void> {
        try {
