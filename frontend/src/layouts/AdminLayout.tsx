    ...
    return (
        <>
            <div className={`flex flex-col mx-auto w-full min-h-screen bg-gray-100 ${(desktopSidebarOpen || mobileSidebarOpen) ? (desktopSidebarOpen ? "lg:pl-64" : "pl-64") : ""}`}>
                <nav className={`flex flex-col fixed top-0 left-0 bottom-0 w-full lg:w-64 h-full bg-white border-r border-gray-200 z-50 transform transition-transform duration-500 ease-out ${(desktopSidebarOpen || mobileSidebarOpen) ? "translate-x-0" : (desktopSidebarOpen ? "lg:-translate-x-full" : "-translate-x-full")}`} aria-label="Main Sidebar Navigation">
                    <div className="h-16 flex-none flex items-center justify-between lg:justify-center px-4 w-full">
                        <a href="" className="inline-flex items-center space-x-2 font-bold text-lg tracking-wide text-primary hover:text-gray-500">
                            <svg
                    ...
                    <div className="overflow-y-auto">
                        <div className="p-4 w-full">
                            ...
                            <div className="px-3 pt-5 pb-2 text-xs font-medium uppercase tracking-wider text-gray-500">
                                ...
                                <Link to="/admin/users" className={`flex items-center space-x-3 px-3 font-medium rounded text-gray-600 hover:text-gray-700 hover:bg-gray-100 active:bg-gray-50`}>
                                    <span className="flex-none flex items-center">
                                        <Users className="hi-outline hi-clipboard-list inline-block w-5 h-5"/>
                                    </span>
                                    <span className="py-2 flex-grow">Users</span>
                                </Link>
                                <Link to="/admin/categories" className={`flex items-center space-x-3 px-3 font-medium rounded text-gray-600 hover:text-gray-700 hover:bg-gray-100 active:bg-gray-50`}>
                                    <span className="flex-none flex items-center">
                ...
                <header className={`flex flex-none items-center h-16 bg-white shadow-sm fixed top-0 right-0 left-0 z-30 ${(desktopSidebarOpen || mobileSidebarOpen) ? (desktopSidebarOpen ? 'lg:pl-64' : 'pl-64') : ''}`}>
                    <div className="flex justify-between max-w-10xl mx-auto px-4 lg:px-8 w-full">
                        <div className="flex items-center space-x-2">
                            <div className="hidden lg:block">
                                <button type="button" onClick={() => onClickDesktopSidebarToggle()} className="inline-flex justify-center items-center space-x-2 border font-semibold focus:outline-none px-3 py-2 leading-6 rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow  focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none">
                                ...
                                <div role="menu" aria-labelledby="tk-dropdown-layouts-user" onMouseLeave={() => setUserDropdownOpen(false)} className={`absolute right-0 origin-top-right mt-2 w-48 shadow-xl rounded z-1  ${userDropdownOpen ? "" : "hidden"}`}>
                                    <div className="bg-white ring-1 ring-black ring-opacity-5 rounded divide-y divide-gray-100">
                                        <div className="p-2 space-y-1">
                                            <a role="menuitem" href="" className="flex items-center space-x-2 rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700">
