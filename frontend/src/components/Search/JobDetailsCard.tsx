...
import { BriefcaseIcon , LocationMarkerIcon, CurrencyDollarIcon, CalendarIcon} from '../Icons';
                ...
                <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
                    <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                        <div className="sm:col-span-2">
                            ...
                            <p className="mt-1 text-sm text-gray-900" dangerouslySetInnerHTML={{__html: job?.description}} />
                        </div>
                    </dl>
                    <div className='mt-3'>
                           <div className="flex">
